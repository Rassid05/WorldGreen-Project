    <style>
        ...
        .login-image {
            background: url('gambar/ev.jpg') center/cover;
            min-height: 100%;
        }
    ...
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <div class="row login-container w-100">
            ...
            <div class="col-md-6 p-5">
                ...
                <p class="text-center text-muted">Sign Up to EcoGreen</p>
                ...
                <p class="text-center mt-3">Have account?<a href="index.php?page=login" class="text-decoration-none">Sign In</a></p>
            </div>
        </div>
    </div>
